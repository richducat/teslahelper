(() => {
  ...
  function getCustomSteps(vehicle, sectionId) {
    ...
    if (sectionId === 'controls') {
      return isStalkCar
        ? ['Use the touchscreen to adjust settings and view vehicle information.','Press the wiper button on the left stalk to wipe the windshield; each press cycles through speeds; hold it to spray washer fluid.','Push the left stalk up or down (or tap the arrow buttons on the steering wheel on newer cars) to signal a turn; press again to cancel.','Use the left scroll wheel on the steering wheel to adjust wiper speed or media volume.','Use the right scroll wheel for Autopilot controls and media.']
        : ['Use the touchscreen to adjust settings and view vehicle information.','Press the wiper button on the steering yoke; each press cycles through speeds; hold to spray washer fluid; adjust the speed by rolling the left scroll button.','Press the turn‑signal buttons on the steering yoke to signal a turn; press again to cancel.','Use the left scroll button to adjust wiper speed, mirrors or brightness.','Use the right scroll button for Autopilot controls and media.'];
    }
    if (sectionId === 'autopilot') {
      return isStalkCar
        ? ['Pull the right drive stalk down once to engage Traffic‑Aware Cruise Control.','Pull the right drive stalk down twice quickly to engage Autosteer (Autopilot).','Adjust the set speed or following distance using the right scroll wheel.','To cancel Autopilot, push the drive stalk up once or press the brake pedal.']
        : ['Press the right scroll button on the steering yoke once to engage Traffic‑Aware Cruise Control.','Press the right scroll button twice quickly to engage Autosteer (Autopilot).','Adjust the set speed or following distance by rolling the right scroll button.','To cancel Autopilot, press the right scroll button or press the brake pedal.'];
    }
